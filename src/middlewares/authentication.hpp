...
//             if (!user.has_value())
//             {
//                 Helper::errorResponse(res, crow::status::BAD_REQUEST, "Failed to extract username.");
//             }
//             else if (!pass.has_value())
//             {
//                 Helper::errorResponse(res, crow::status::BAD_REQUEST, "Failed to extract password.");
//             }
//             return;
//         }
