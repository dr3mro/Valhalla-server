...
struct Permissions
{
   public:
    ...
    {
        USER       = 0,       // 00000000
        PROVIDER   = 1 << 0,  // 00000001
        CAN_READ   = 1 << 1,  // 00000010
        CAN_WRITE  = 1 << 2,  // 00000100
        CAN_DELETE = 1 << 3,  // 00001000
        IS_ADMIN   = 1 << 4,  // 00010000
        IS_OWNER   = 1 << 5,  // 00100000
        IS_SUPER   = 1 << 6,  // 01000000
    };  // 10000000
    ...
    {
        return static_cast<PowerLevel>(static_cast<int>(a) | static_cast<int>(b));
    }
   ...
   private:
    ...
    bool hasMatch(const PowerLevel &permission, const PowerLevel &check) const
    {
        return static_cast<int>(permission & check) != 0;
    }
};