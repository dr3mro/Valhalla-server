...
class ClientControllerBase
{
   public:
    ...
    virtual std::optional<uint64_t> Login(CALLBACK_&& callback, std::string_view data)                              = 0;
    virtual void                    Logout(CALLBACK_&& callback, const std::optional<std::string>& token)           = 0;
