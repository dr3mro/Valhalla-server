...
class AppointmentController : public EntityController<T>, public AppointmentControllerBase
{
   public:
    ...
    void Read(const crow::request &req, crow::response &res, const jsoncons::json &request_json) override;
    void Update(const crow::request &req, crow::response &res, const jsoncons::json &request_json) override;
    void Delete(const crow::request &req, crow::response &res, const jsoncons::json &request_json) override;
