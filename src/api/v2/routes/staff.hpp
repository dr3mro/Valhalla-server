    ...
    namespace v2
    {
        class Staff : public drogon::HttpController<Staff>
        {
           public:
            ...
            METHOD_LIST_BEGIN
            METHOD_ADD(Staff::Invite, "/services/{serviceType}/staff/invite", drogon::Post, ELAPSED, AUTH);
            METHOD_ADD(Staff::Add, "/services/{serviceType}/staff/add", drogon::Post, ELAPSED, AUTH);
            METHOD_ADD(Staff::Remove, "/services/{serviceType}/staff/remove", drogon::Post, ELAPSED, AUTH);
            METHOD_LIST_END
